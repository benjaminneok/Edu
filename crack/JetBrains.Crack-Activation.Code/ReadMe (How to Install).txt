...
1. Install JetBrains
3. for Winodws OS: Copy "jetcrack.jar" to Drive C:
4. Go to install directory product JetBrains find *.exe.vmoptions open with Notepad++ add end line & Save:

windows:
-javaagent:c:/jetcrack.jar

mac:
-javaagent:/Users/neo/jetcrack.jar

linux:
-javaagent:/home/neo/jetcrack.jar


5. open JetBrains and copy code to Activation Code and Active
